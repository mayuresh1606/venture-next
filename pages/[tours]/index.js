        ...
        <div className="my-container font-size-small">
            ...
            <table className="table grey-bg-table table-striped">
                ...
                {/* <tbody className="font-weight-light"> */}
                    ...
                    <tr className="blue-color" style={{"height": "min-content"}}>
                            ...
                            <td>COMFORT</td>
                            <td>
                                {tour.comfortName}{tour.visit && <><br /><p className="visit">{tour.visit}</p></>}
                            </td>
                            <td width="15%">
            ...
            {tours.map((tour) => <section key={tour._id} id={`tour-${tour.tourNumber}`}>
                ...
                <p>
                    ...
                    Cheque / Demand draft should be in favour of &quot;VENTURE WORLD&quot;
                    <br /> for more information about <span className="font-weight">Terms / Tour cost does not include / Cancellation policy / Neccessary documents</span> click <Link href="#tourCost" style={{color:"blue", textDecoration:"underline"}}> here</Link></p>
                    <hr /><br />
            </section>
            )}
            <section id="tourCost">
                ...
                <ul>
                    ...
                    <li>Venture World
                        <ul>
                            ...
                            responsibility.</li>
                            <li>Strictly prohibits smoking and drinking alcohol during the rail/ bus journey / in the dining halls.</li>
                    ...
                    publicity material (stills / video).</li>
                    ...
                    carried from the Venture World office, only after making the full payment. Tickets and itinerary will not be sent by
                    courier.</li>
            ...
            {/* <div className="cancellation">
                ...
                <ul>
                    ...
                    <li>From 89 to 60 days prior to the departure of the tour 70%</li>
                    <li>From 59 to 30 days, prior to the departure of the tour 50%</li>
