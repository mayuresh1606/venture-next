        ...
        <div className="my-container font-size-small">
            ...
            {tours.map((tour) => <section key={tour._id} id={`tour-${tour.tourNumber}`}>
                ...
                <p>
                    ...
                    <br /> for more information about <span className="font-weight">Tour cost does not include / Cancellation policy / Neccessary documents / Terms</span> click <Link href="#tourCost" style={{color:"blue", textDecoration:"underline"}}> here</Link></p>
                    <hr /><br />
            </section>
            )}
            <section id="tourCost">
